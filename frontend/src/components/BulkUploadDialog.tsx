...
const BulkUploadDialog: React.FC<BulkUploadDialogProps> = ({
  ...
  const getDescription = () => {
    switch (type) {
      ...
      case 'groups':
        return 'Введите названия групп, каждое с новой строки. Порядок отображения будет установлен автоматически. Ассистента можно назначить после создания группы.';
      case 'assistants':
